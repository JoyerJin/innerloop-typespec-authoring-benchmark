...
Add a new preview version `2025-05-04-preview` to my service. In this new version, I want to add a new property `department` of type `string` to `EmployeeProperties`.
